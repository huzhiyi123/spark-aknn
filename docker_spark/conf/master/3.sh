--class org.apache.spark.examples.SparkPi
 --master spark://192.168.123.101:7077 lib/spark-examples-1.0.0-hadoop2.2.0.jar
...
function function_name {
    ...
    echo $abpath
    nohup spark-submit \
    --master spark://b53cb1e828da:7077 \
    --conf spark.driver.maxResultSize=2G \
    --conf spark.scheduler.listenerbus.eventqueue.capacity=100000 \
     --conf spark.shuffle.service.enabled=true \
    --packages $package --driver-memory 10G --class org.apache.spark.examples.SparkPi \
    /usr/spark-2.4.1/examples/jars/spark-examples_2.11-2.4.1.jar > $abpath 
